...
df_series_top100 <- read_csv("https://raw.githubusercontent.com/klassik199/academic-works/refs/heads/main/projects/tv-series-popularity/data/series_dataframe_top100.csv")

df_series_top500 <- read_csv("https://raw.githubusercontent.com/klassik199/academic-works/refs/heads/main/projects/tv-series-popularity/data/series_dataframe_top500.csv")

df_series_top1000 <- read_csv("https://raw.githubusercontent.com/klassik199/academic-works/refs/heads/main/projects/tv-series-popularity/data/series_dataframe_top1000.csv")
  ...
  df_series_sub1_table <- reactive({
    df <- req(df_series_sub1()) %>% 
      ...
      mutate(avgRatingGenre = round(mean(seriesAvgRating), 2),
             ...
             medRatGenre = round(median(seriesAvgRating), 2),
